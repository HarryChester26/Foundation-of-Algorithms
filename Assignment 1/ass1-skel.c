...
void stage_1(int total_candidates, int votes[VOTE_LIMIT][CANDIDATE_LIMIT],
...
int main(int argc, char *argv[]) {
  ...
  stage_1(total_candidates, voter, all_candidates);
...
void stage_1(int num_candidates, int voter[VOTE_LIMIT][CANDIDATE_LIMIT],
             Candidate_t all_candidates[CANDIDATE_LIMIT]) {
